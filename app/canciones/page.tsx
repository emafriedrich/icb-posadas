...
const cancionesPorFecha = [
  {
    ...
    slug: "domingo-17",
    canciones: [
       { id: 5, titulo: "Levántate, iglesia del Señor", artista: "", duracion: "4:32" },
      { id: 1, titulo: "Todo lo que creó el Rey", artista: "", duracion: "3:45" },
      { id: 3, titulo: "Habla, oh Dios", artista: "", duracion: "4:12" },
      { id: 6, titulo: "Hubo quien por mí culpa", artista: "", duracion: "3:28" },
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-lg sm:text-2xl font-bold text-gray-900 truncate">Canciones</h1>
        ...
        {cancionesPorFecha.map((evento, index) => (
          <Card key={index} className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              ...
              <div className="space-y-2 mb-4">
                {evento.canciones.slice(0, 3).map((cancion) => (
                  ...
                  >
                    ...
                    <span className="hidden sm:inline truncate">{cancion.artista}</span>
                  </div>
                ))}
              ...
              {/* Botón ver todas */}
              <Button asChild className="w-full bg-primary hover:bg-primary-dark h-10 sm:h-11">
